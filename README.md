...
A command-line tool for managing 2v2 tournaments. Originally built for FIFA gaming sessions with friends, but works for any 2v2 competition.

## Features

- **Complete 2v2 matchmaking**: Automatically generates all possible matchups where every player plays with and against everyone else
